...
import { Camera, LogIn, PlusSquare, Search, UserCircle, UserCog, Users } from "lucide-react";
                ...
                <div className="pl-3 border-l border-border/40">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent className="w-56" align="end" forceMount>
                      ...
                      {user.role === "creator" && (
                        <DropdownMenuItem asChild>
                          <Link href={`/creator/${user.id}`} className="cursor-pointer flex items-center gap-2">
                            <UserCircle className="w-4 h-4" /> My Gallery
                          </Link>
                        </DropdownMenuItem>
                      )}
                      <DropdownMenuSeparator />
